...
export const CsharpIcon = () => (
  <CsharpOriginalIcon className="my-class" size="100%" />
)

export const Css3Icon = () => (
  <Css3OriginalIcon className="my-class" size="100%" />
)

export const DockerIcon = () => (
  <DockerOriginalIcon className="my-class" size="100%" />
)

export const DotNetIcon = () => (
  <DotNetOriginalIcon className="my-class" size="100%" />
)

export const DotnetcoreIcon = () => (
  <DotnetcoreOriginalIcon className="my-class" size="100%" />
)
